...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ngraph_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("196dc021-d7b6-566c-9f9d-30dab4436127"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ngraph", artifacts_toml) for e in artifacts["ngraph"]]
...
if best_platform === nothing
    @debug("Unable to load ngraph; unsupported platform $(triplet(platform_key_abi()))")
else
